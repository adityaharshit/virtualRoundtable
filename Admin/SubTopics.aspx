<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SubTopics.aspx.cs" Inherits="WebApplication3.Admin.SubTopics" %>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div calss ="col-sm-6 col-md-4 col-lg-4">
                                            <h4 class="sub-title">Sub-Topic</h4>
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label>Topic</label>
                                                    <div>
                                                        <asp:DropDownList ID="ddlTopic" runat="server" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="TName" DataValueField="TopicId" AppendDataBoundItems="true">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                                            ...
                                                            SetFocusOnError="true" ControlToValidate="ddlTopic" InitialValue="0">
                                        ...
                                        <div class ="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            <h4 class="sub-title">Sub-Topic Lists</h4>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument ='<%# Eval("SubTId") %>' CommandName="edit"  CausesValidation="false">
                                                                        <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        CssClass="badge bg-danger" CommandArgument='<%# Eval("SubTId") %>'
